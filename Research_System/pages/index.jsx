        ...
        >
          ...
          <div className="flex flex-col gap-6">
            {articles.map((article) => (
              <Link href={`/${article.id}`} key={article.id} className="group block p-6 border border-white/5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] hover:border-[#990000]/40 transition-all duration-500">
                <article>
