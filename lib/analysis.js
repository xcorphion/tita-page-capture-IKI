...
/**
 * Biblioteca de Análise Estatística para Dinâmica de Digitação
 * Implementa Pearson r, Cohen's d e Parâmetros Lognormais.
 */

/**
 * Calcula a correlação de Pearson entre dois arrays.
 */
 ...
 */
function getCohensD(groupA, groupB) {
...
/**
 * Retorna os terços (superior e inferior) de um conjunto de dados baseado em um critério.
 */
function getTerciles(data, criterionKey, valueKey) {
