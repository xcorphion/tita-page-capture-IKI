...
export default function IKIResearchPage() {
    ...
    const handleFinalSubmit = async (genuine) => {
        ...
        try {
            ...
            router.push(`/study/IKI/${respondentId}/finish`);
        } catch (e) { console.error(e); }
    };
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 20 }}>
                            {[
                                ...
                                <div key={item.num} style={{ display: 'flex', gap: 16, alignItems: 'flex-start', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '16px 20px' }}>
                                    ...
                                    <div>
                                        <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.75)', marginBottom: 4, lineHeight: 1.3 }}>{item.label}</p>
                                        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: 'rgba(255,255,255,0.45)', lineHeight: 1.7, margin: 0, fontWeight: 300 }}>{item.text}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
